...
# Device configuration file for Galaxy S10e (beyond0lte)
...
TARGET_HFR_MODE="0"
TARGET_HFR_SUPPORTED_REFRESH_RATE=""
...
TARGET_SSRM_CONFIG_NAME="siop_beyond0_exynos9820"
